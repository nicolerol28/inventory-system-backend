package com.miapp.inventory_system.shared.security;
...
public class SecurityConfig {
        ...
        http
                ...
                .exceptionHandling(ex -> ex
                        .authenticationEntryPoint((request, response, authException) -> {
                            ...
                            response.getWriter().write("{\"status\":401,\"error\":\"Unauthorized\",\"message\":\"Se requiere autenticación\",\"path\":\"" + request.getRequestURI() + "\"}");
                        })
                )
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of(
                ...
                "https://chat.nicoleroldan.com",
                "https://reports.nicoleroldan.com"
